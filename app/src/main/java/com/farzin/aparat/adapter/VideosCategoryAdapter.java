...
public class VideosCategoryAdapter extends RecyclerView.Adapter<VideosCategoryAdapter.MyViewHolder>{

    private Context c;
    private List<Videos> videosList;

    public VideosCategoryAdapter(Context c, List<Videos> videosList) {
        this.c = c;
